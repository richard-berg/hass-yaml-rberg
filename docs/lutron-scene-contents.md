  ...
  controlled_entities:
    ...
    - entity_id: light.master_bathroom_vanity_lights
      ...
      setting:
        ...
        color_mode: "brightness"
  not_controlled_count: 28
scene.master_bath_night_mode:
  name: "Master Bath Night Mode"
  controlled_entities:
    - entity_id: light.master_bathroom_commode
      name: "Master Bathroom Commode"
      setting:
    ...
    - entity_id: light.master_bathroom_vanity_lights
      ...
      setting:
        state: "off"
  not_controlled_count: 28
scene.master_bath_normal:
  name: "Master Bath Normal"
  controlled_entities:
    - entity_id: light.master_bathroom_commode
      name: "Master Bathroom Commode"
      setting:
  ...
  controlled_entities:
    ...
    - entity_id: light.living_room_stage_spot_lights
      ...
      setting:
        ...
        color_mode: "brightness"
  not_controlled_count: 29
scene.stage_etc_bright:
  name: "Stage Etc Bright"
  controlled_entities:
    - entity_id: light.dining_room_beer_shelf
      name: "Dining Room Beer Shelf"
      setting:
    ...
    - entity_id: light.living_room_walkway
      ...
      setting:
        ...
        brightness: 255
        color_mode: "brightness"
  not_controlled_count: 20
scene.stage_etc_focus:
  name: "Stage Etc Focus"
  controlled_entities:
    - entity_id: light.dining_room_beer_shelf
      name: "Dining Room Beer Shelf"
      setting:
    ...
    - entity_id: light.living_room_walkway
      ...
      setting:
        state: "off"
  not_controlled_count: 15
scene.stage_etc_mood:
  name: "Stage Etc Mood"
  controlled_entities:
    - entity_id: light.dining_room_beer_shelf
      name: "Dining Room Beer Shelf"
  ...
  controlled_entities:
    ...
    - entity_id: light.theater_dresser_right
      ...
      setting:
        ...
        brightness: 255
        color_mode: "brightness"
  not_controlled_count: 26
scene.theater_desk_work:
  name: "Theater Desk Work"
  controlled_entities:
    - entity_id: light.theater_clouds_front
      name: "Theater Clouds Front"
      setting:
